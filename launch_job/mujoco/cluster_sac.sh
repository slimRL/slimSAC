...
sbatch --job-name $EXPERIMENT_NAME-$ALGO_NAME --array=$FIRST_SEED-$LAST_SEED --cpus-per-task=4 --mem-per-cpu=$((N_PARALLEL_SEEDS * 2))G --time=4:00:00 --gres=gpu:1 --prefer="rtx3090|a5000" --partition gpu \
